...
public class ConfirmDesignationDeletion extends HttpServlet
{
...
pw.println("<h5>Do you really want to delete "+designation.getTitle()+"</h5>");
...
pw.println("</form>");
pw.println("<form id='deletionForm' action='/styleone/designationsView'>");
pw.println("</form>");
pw.println("</div>");
