...
/*
After Finalising I will remove this piece of code
...
{
// here first I have to check in hash Map then if it is aviable in hashmap then forward otherwise 500 page should be return
// one more thing if it is jsp then it should be forward to jsp resource just like we done at below.
