...
System.out.println("Inject Application Directory: "+injectApplicationDirectory);
System.out.println("Inject Application Scope: "+injectApplicationScope);
System.out.println("Inject Session Scope: "+injectSessionScope);
System.out.println("Inject Request Scope: "+injectRequestScope);
System.out.println("---------------------"+objectCount+"---------------------");
objectCount++;

service=new Service(c,str+str2,forwardTo,m,isGetAllowed,isPostAllowed,false,priority,injectApplicationDirectory,injectApplicationScope,injectSessionScope,injectRequestScope);
